 ...
 * @author natal
 */
public class OpManMaquinaBossController implements Initializable {
    
    @FXML
    private Button inicManMaqB;
    @FXML
    private ComboBox<?> maqManMaqB;
    @FXML
    private Button cadasManMaqB;
    @FXML
    private Button inicManMaqB1;
    
    private void OpcoesManMaqBoss(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("OpManMaquinaBoss.fxml"));
