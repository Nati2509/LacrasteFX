 ...
 * @author natal
 */
public class OpModelagemBossController implements Initializable {
    
    @FXML
    private void OpcoesModeBoss(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("OpModelagemBoss.fxml"));
