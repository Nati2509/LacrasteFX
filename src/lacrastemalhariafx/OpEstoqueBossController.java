 ...
 * @author natal
 */
public class OpEstoqueBossController implements Initializable {
    
    @FXML
    private void OpcoesEstoqueBoss(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("OpEstoqueBoss.fxml"));
