 ...
 * @author natal
 */
public class OpCorteCosturaBossController implements Initializable {
    
    @FXML
    private void OpcoesCorteCostBoss(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("OpCorteCosturaBoss.fxml"));
