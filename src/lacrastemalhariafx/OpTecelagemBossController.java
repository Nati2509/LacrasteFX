 ...
 * @author natal
 */
public class OpTecelagemBossController implements Initializable {
    
    @FXML
    private void OpcoesTeceBoss(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("OpTecelagemBoss.fxml"));
