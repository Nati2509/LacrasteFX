 ...
 * @author natal
 */
public class OpPesModaBossController implements Initializable {
    
    @FXML
    private void OpcoesPesModaBoss(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("OpPesModaBoss.fxml"));
